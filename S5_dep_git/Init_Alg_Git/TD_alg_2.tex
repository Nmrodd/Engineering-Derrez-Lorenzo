...
\begin{minipage}[c]{10cm}
    \includegraphics[width=10cm]{arbre_appels_f4.png}
\end{minipage}
\\[0.3em]
Alors : 
\begin{itemize}
    \item Le nombre total d'états de la pile est : $2 \times $ (nombre total d'appels de fonctions executées).
    \item \underline{Résultat} : \textbf{48 états}.  
\end{itemize}
...
\begin{enumerate}
    \item Hauteur : n-1
    \item Pile max : n 
    \item Nombre d'appels : n 
    \item Nombre de noeuds : n 
\end{enumerate}

\subsection*{exponentialSlow(n) :}
\begin{enumerate}
    \item Hauteur : n
    \item Pile max : n+1 
    \item Nombre d'appels : n+1 
    \item Nombre de noeuds : n+1
\end{enumerate}

\subsection*{exponentialVerySlow(n) :}
\begin{enumerate}
    \item Hauteur : n
    \item Pile max : n+1 
    \item Nombre d'appels : 2$^{n+1}$-1 
    \item Nombre de noeuds : 2$^{n+1}$-1
\end{enumerate}
